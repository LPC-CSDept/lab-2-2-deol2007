def main():
   ...
   ##################################################
    ...
    print(f"Regular hours: {reg_hours} Regular Salary: {regular_wage}$")
    print(f"Overtime hours: {overtime} Overtime Salary: {overtime_wage:.2f}$")
    print(f"Total Salary : {total_wage:.2f}$")
